...
MIDDLEWARE = [
    ...
    'backend_python.middleware.cross_domain_middleware.CrossDomainMiddleware',
    'backend_python.middleware.exception_middleware.ExceptionMiddleware',
    'backend_python.middleware.http_log_middleware.HTTPLogMiddleware',
]
